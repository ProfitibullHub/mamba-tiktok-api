-- 1. Update user_can_manage_tenant_members to allow AMs
        ...
        OR (
            ...
            AND (
                ...
                OR EXISTS (
                    ...
                    WHERE tm.tenant_id = p_tenant_id AND tm.user_id = p_actor_id AND tm.status = 'active'
...
-- 2. Update tenant_set_member_role to allow AMs to set AC role
...
-- 3. Update tenant_set_member_role_for_actor (same logic as above but explicit p_actor_id)
...
-- 4. Update agency_add_staff_membership (just in case it's used directly)
